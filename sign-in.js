...
document.addEventListener('DOMContentLoaded', () => {
    ...
    customBtn.addEventListener('click', () => {
        const googleAuthUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=83470708869-jp3k1ajdp0n3jqvi7gv1t37715ukijmg.apps.googleusercontent.com&redirect_uri=${encodeURIComponent('https://contentvault.club/google-callback-signin.html')}&response_type=token id_token&scope=openid%20email%20profile&nonce=${generateRandomNonce()}`;
